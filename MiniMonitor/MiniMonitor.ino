...
void setup()
{
	...
	byte buttons[] = { 0x03, 0xff, 0xff, 0xff, 0xff };
...
void loop()
{
	...
	//char buf[4];
	//u8g2.drawStr(0, 50, itoa(color, buf, 10));	// write something to the internal memory

	//char buf2[8];
	//u8g2.drawStr(30, 50, itoa(tick, buf2, 10));	// write something to the internal memory


	u8g2.setFont(u8g2_font_logisoso34_tn);
	u8g2.drawStr(0, 64 - (64 - 16 - 34) / 2, "22:46");	// write something to the internal memory
